...
class GEGSOM(object):
    ...
    def __init__(self, radius=10, min_rad=6, lrst=0.5, sf=0.9, fd=0.9, sd=0.035, cluster_spacing_factor=1., its=10,
                 labels=np.array([]), momentum=0., map_structure=6, neighbor_func='gaussian', verbose=False):
        self.lrst = lrst
        self.its = its
        self.fd = fd
        self.wdst = sd
