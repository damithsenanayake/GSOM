...
model = GSOM(lrst=.5, sf=0.9, fd = .8, radius=6., min_rad = 2.,cluster_spacing_factor=1., sd=.03, its=30, labels=labels, momentum=.08, map_structure=6, pmink=2, neighbor_func='cut_gaussian')
