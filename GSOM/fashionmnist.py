...
model = GSOM(lrst=.8, sf=0.9, fd = .99, radius=6., min_rad = 4., sd=.04, its=20, cluster_spacing_factor=.78, labels = labels, momentum=.8, map_structure='hex', neighbor_func='epanechicov')
