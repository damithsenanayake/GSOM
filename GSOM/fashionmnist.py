...
model = GSOM(lrst=.4, sf=0.0001, fd = .9, radius=4., min_rad = 3., sd=.08, its=10, labels=labels, cluster_spacing_factor=.85, momentum=.15, map_structure=5, neighbor_func='gaussian')
