...
model = GSOM(lrst=.5, sf=0.9, fd = .2, radius=4., min_rad = 2., sd=.4, its=20, labels=labels, cluster_spacing_factor=.1, momentum=.0, map_structure='hex', neighbor_func='cut_gaussian')
