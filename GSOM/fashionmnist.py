...
model = GSOM(lrst=.8, sf=0.0001, fd = .9, radius=4., min_rad = 3., sd=.08, its=20, labels=labels, cluster_spacing_factor=.8, momentum=.15, map_structure=6, neighbor_func='gaussian')
