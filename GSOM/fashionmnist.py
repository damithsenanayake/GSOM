...
model = GSOM(lrst=.5, sf=0.0001, fd = .9, radius=4., min_rad = 3., sd=.02, its=40, labels=labels, cluster_spacing_factor=.9, momentum=.15, map_structure=6, neighbor_func='gaussian')
