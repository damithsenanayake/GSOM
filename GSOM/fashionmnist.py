...
dat = PCA(10, random_state=1).fit_transform(dat)[order]
# dat -= dat.min()
# dat /= dat.max()
...
model = GSOM(lrst=.5, sf=0.8, fd = .99999, radius=4., min_rad = 3., sd=.02, its=20, cluster_spacing_factor=.8, labels = labels)
