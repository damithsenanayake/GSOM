...
model = GSOM(lrst=.5, sf=0.8, fd = .8, radius=6., min_rad = 4., sd=.4, its=20, labels=labels, cluster_spacing_factor=.75, momentum=.0, map_structure=6, neighbor_func='cut_gaussian')
